...
CREATE TABLE IF NOT EXISTS `mydb`.`Day_of_the_Week` (
  ...
  PRIMARY KEY (`Day_of_the_Week`, `Schedule_HotelID`, `Schedule_EmployeeID`, `Schedule_Position`),
  INDEX `fk_Day_of_the_Week_Schedule1_idx` (`Schedule_HotelID` ASC, `Schedule_EmployeeID` ASC, `Schedule_Position` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`Schedule_has_Room`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Schedule_has_Room` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Schedule_has_Room` (
  `Schedule_HotelID` INT NOT NULL,
  `Schedule_EmployeeID` INT NOT NULL,
  `Schedule_Position` VARCHAR(45) NOT NULL,
  `Room_RoomNumber` VARCHAR(5) NOT NULL,
  `Room_Floor` INT NOT NULL,
  `Room_RoomTypeName` VARCHAR(45) NOT NULL,
  `Room_HotelID` INT NOT NULL,
  PRIMARY KEY (`Schedule_HotelID`, `Schedule_EmployeeID`, `Schedule_Position`, `Room_RoomNumber`, `Room_Floor`, `Room_RoomTypeName`, `Room_HotelID`),
  INDEX `fk_Schedule_has_Room_Room1_idx` (`Room_RoomNumber` ASC, `Room_Floor` ASC, `Room_RoomTypeName` ASC, `Room_HotelID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Schedule_has_Room_Room1`
    FOREIGN KEY (`Room_RoomNumber` , `Room_Floor` , `Room_RoomTypeName` , `Room_HotelID`)
...
SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS;
SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS;
>>>>>>> fbbaa40a8e59526b2ed1c9203498205236ab5468
